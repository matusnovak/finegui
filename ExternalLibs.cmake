...
elseif(UNIX)
  set(FINEGRAPHICS_LIBRARY ${CMAKE_BINARY_DIR}/FINEGRAPHICS-prefix/src/FINEGRAPHICS-build/${CMAKE_BUILD_TYPE}/libfinegraphics.so)
  set(FINEGRAPHICS_BIN ${CMAKE_BINARY_DIR}/FINEGRAPHICS-prefix/src/FINEGRAPHICS-build/${CMAKE_BUILD_TYPE}/libfinegraphics.so)
endif()
